<main>
    ...
    <div class="bg-gray-500 h-auto"
        ...
        <div class="flex justify-center items-center h-screen">
            <img src="{{ asset('images/logo-takumi.png') }}" class="w-80">
        </div>
        <div class="w-full bg-black bg-opacity-40 py-5 text-white">
            <div class="container mx-auto md:flex justify-between items-center gap-10">
                <p class="md:w-3/4">
                    ...
                    mencetak
                    lulusan yang siap menghadapi tantangan global. Jadilah bagian dari keluarga besar Takumi dan raih
                    prestasi
                    gemilang.
                </p>
                <div class="py-5 md:py-0">
                    <a href="" class="flex items-center justify-center px-6 py-2 bg-primary w-auto rounded-xl">
                        <i class='bx bx-user mr-2'></i> Pendaftaran
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="mt-20 bg-primary w-full h-auto text-white">
        ...
        <div class="container py-5">
            ...
            <div class="flex justify-end">
                <p class="w-full md:w-2/3 text-lg ">
                <ul>
                    <li>1. Menyelenggarakan pendidikan vokasi yang berorientasi pada praktik, mendorong mahasiswa untuk
                        menciptakan produk nyata yang bernilai tambah.
                    </li>
                    <li>
                        2. Membudayakan semangat inovasi dan kewirausahaan di kalangan mahasiswa.
                    </li>
                </ul>
                </p>
            </div>
